...
dbutils.fs.put('/Users/david.harris@databricks.com/test_data/spend_csv/spend.csv', spend_csv, True)
...
dbutils.fs.put('/Users/david.harris@databricks.com/test_data/users_json/users.json', users_json, True)
